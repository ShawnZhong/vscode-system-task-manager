...
export function listProcesses(
  ...
  return new Promise((resolve, reject) => {
    ...
    if (process.platform === "win32") {
      ...
      if (withLoad) {
        const CMD =
          "wmic process get CommandLine,ParentProcessId,ProcessId,WorkingSetSize && wmic path win32_perfformatteddata_perfproc_process where (PercentProcessorTime ^> 0) get IDProcess,PercentProcessorTime";
